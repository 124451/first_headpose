...
class FaceBoxes(nn.Module):
  ...
  def __init__(self, phase, size, num_classes):
    ...
    self.conv2 = CRelu1(32, 64, kernel_size=3, stride=1, padding=1)
    
    self.inception1 = Inception()

    self.incep_2 = BasicConv2d(128, 128, kernel_size=3, stride=2, padding=1)

    self.inception2 = Inception()

    self.conv3_2 = BasicConv2d(128, 128, kernel_size=3, stride=2, padding=1)
