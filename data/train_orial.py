...
if __name__ == '__main__':
    args = parse_args()
    writer = SummaryWriter("out/scalar_example")
    cudnn.enabled = True
    ...
    if not os.path.exists('output/snapshots_add_mask'):
        os.makedirs('output/snapshots_add_mask')
    ...
    if args.snapshot == '':
        ...
        saved_state_dict = torch.load('/media/omnisky/D4T/huli/work/headpose/output/snapshots_add_mask/_epoch_5.pkl')
    ...
    # epoch = 0
        ...
        # writer.add_scalar("pitch/roll/yaw",{"loss_yaw":loss_yaw.item(),'loss_pitch':loss_pitch.item(),'loss_roll':loss_roll.item()},iteration)
        ...
        torch.save(
            model.state_dict(),
            'output/quare_face/' + args.output_string +
